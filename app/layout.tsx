      ...
      <body style={{
        ...
        <div style={{
          ...
          <nav style={{
            ...
            <div>
              <a href="/" style={{ marginRight: "20px", color: "#e2e8f0" }}>Home</a>
              <a href="/projects" style={{ marginRight: "20px", color: "#e2e8f0" }}>Projects</a>
              <a href="/about" style={{ marginRight: "20px", color: "#e2e8f0" }}>About</a>
